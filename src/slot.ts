...
import helmlok from "../assets/helmlok.png";
import skully from "../assets/skully.png";
const app = new PIXI.Application({ backgroundColor: 0x1099bb });

app.loader
  .add([
    { name: "assets/eggHead.png", url: eggHead },
    { name: "assets/flowerTop.png", url: flowerTop },
    { name: "assets/helmlok.png", url: helmlok },
    { name: "assets/skully.png", url: skully }
  ])
  .load(onAssetsLoaded);
